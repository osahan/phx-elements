...
const Reloader = function (options = {}) {
    if (!options || !options.reloaderCallback) {
        throw new Error(
            'You need to pass reloaderCallback for the reloader to work'
        );
    }
    ...
    return (target) => {
        ...
        target.prototype.connectedCallback = function () {
            ...
            const reloadFn = target.prototype[options.reloaderCallback].bind(
                this
            );
